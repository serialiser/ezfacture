...
class Entity:
    ...
    Evolution O.M. : je passe des endpoint en dur à l'initialisation "ES76281415Y", endpoint_scheme="ES:VAT" afin d'éviter de modifier le code, car je ne m'en sers pas
    ...
    def __init__(self, name=None, tax_scheme=None, tax_scheme_id=None, country=None,
                 ...
                 postalzone=None, city=None, address=None, address2=None, province=None,
                 endpoint="ES76281415Y", endpoint_scheme="ES:VAT"):
