...
class Invoice:
    ...
    def issue_date(self, date):
        ...
        if not date:
            ...
            self._issue_date = date.strftime("%Y%m%d")  # Evolution O.M.
    ...
    def tax_amount(self, tax_type=None):
        ...
        if tax_type is None:
            ...
            taxes = {tax_type}
        result = (self.taxable_base(tax_type=tax) * tax.percent for tax in taxes if tax is not None)  # Correction O.M.
